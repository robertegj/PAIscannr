...
╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝     ╚═╝╚══════╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚══════╝╚═╝  ╚═╝"  
echo ""
echo "Osint tool based on namechk.com for checking usernames on more than 100 websites."
echo ""
echo "								Developed by HATI"
...
invp(){
	...
	echo "		Examples:"
	echo ""
	echo "	 	- Search available username:"
	echo "				./namechk.sh <username> -au"
	echo ""
	echo "		- Search available username on specifics websites:"
	echo "				./namechk.sh  <username> -au -co"
	echo ""
	echo "	 	- Search available username list:"
	echo "				./namechk.sh -l -fu"
	echo ""
	echo "	 	- Search used username:"
	echo "				./namechk.sh <username> -fu"
	echo ""
	echo "	 	- Search used username on specifics websites:"
	echo "				./namechk.sh <username> -fu -co"
	echo ""
	echo "	 	- Search used username list:"
	echo "				./namechk.sh -l -fu"
	echo ""
}
